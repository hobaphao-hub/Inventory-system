...
# =======================
    ...
    with func_row2_col3:
        st.markdown(
            ...
            <div class="function-card">
                <div class="function-icon">❓</div>
                <div class="function-title">Hướng dẫn & trợ giúp</div>
                <div class="function-desc">Xem tài liệu hướng dẫn nhanh, câu hỏi thường gặp và thông tin liên hệ hỗ trợ.</div>
                <div class="function-subtitle">Tối ưu cách sử dụng hệ thống</div>
            </div>
            """,
            unsafe_allow_html=True,
        )
        st.button("Xem hướng dẫn >", key="btn_help", use_container_width=True)
